...
export default function HomePage() {
  ...
  const domainTab1 = (
    <div className="space-y-6">
      ...
      <Chart
        ...
        title="Carbon Performance Trend"
        height={400}
      />
    </div>
  );
  ...
  const domainTab2 = (
    <div className="space-y-6">
      <div className="grid grid-cols-1 gap-4 lg:grid-cols-2">
        ...
        />
        <ActionMemo
          persona={{ name: 'Vietnam Operations Lead', role: 'Director of Carbon' }}
          context={{}}
          onGenerate={async () => ({
            subject: 'Action Required',
            body: 'AI-generated recommendation based on current data patterns and predicted trends.',
            urgency: 'HIGH',
            actions: ['Review top grid curtailment findings', 'Optimize plant allocation', 'Prepare quarterly carbon report'],
          })}
        />
      </div>
    </div>
  ...
  const tabs = [
    ...
    { id: 'domain-1', label: 'Carbon Analytics', icon: '📈', content: domainTab1 },
